...
export const Header = () => {
  ...
  return (
    <div className="fixed w-screen z-10 bg-redDefault flex items-center justify-between px-5 py-1 md:px-20 lg:w-full lg:px-28 lg:relative 2xl:px-60">
      <Image alt="Logo da Empresa" src={LogoHeader} />
